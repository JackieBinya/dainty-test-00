...
export const LazyFooterSection = import(
  "../../components/footer-section.vue" /* webpackChunkName: "components/footer-section" */
).then((c) => c.default || c)
export const LazyHeaderSection = import(
  "../../components/header-section.vue" /* webpackChunkName: "components/header-section" */
).then((c) => c.default || c)
export const LazyLoader = import(
  "../../components/loader.vue" /* webpackChunkName: "components/loader" */
).then((c) => c.default || c)
export const LazyLogo = import(
  "../../components/logo.vue" /* webpackChunkName: "components/logo" */
).then((c) => c.default || c)
export const LazyPricingTable = import(
  "../../components/pricing-table.vue" /* webpackChunkName: "components/pricing-table" */
).then((c) => c.default || c)
...
export const LazyAboutHeader = import(
  "../../components/about/about-header.vue" /* webpackChunkName: "components/about-header" */
).then((c) => c.default || c)
export const LazyAboutInfo = import(
  "../../components/about/about-info.vue" /* webpackChunkName: "components/about-info" */
).then((c) => c.default || c)
export const LazyAboutStarted = import(
  "../../components/about/about-started.vue" /* webpackChunkName: "components/about-started" */
).then((c) => c.default || c)
export const LazyAboutTerms = import(
  "../../components/about/about-terms.vue" /* webpackChunkName: "components/about-terms" */
).then((c) => c.default || c)
export const LazyAboutValues = import(
  "../../components/about/about-values.vue" /* webpackChunkName: "components/about-values" */
).then((c) => c.default || c)
...
export const LazyCallToAction = import(
  "../../components/home/call-to-action.vue" /* webpackChunkName: "components/call-to-action" */
).then((c) => c.default || c)
export const LazyFeaturesSection = import(
  "../../components/home/features-section.vue" /* webpackChunkName: "components/features-section" */
).then((c) => c.default || c)
export const LazyMediaSection = import(
  "../../components/home/media-section.vue" /* webpackChunkName: "components/media-section" */
).then((c) => c.default || c)
export const LazyPortfolioExamples = import(
  "../../components/home/portfolio-examples.vue" /* webpackChunkName: "components/portfolio-examples" */
).then((c) => c.default || c)
export const LazyPricingCards = import(
  "../../components/home/pricing-cards.vue" /* webpackChunkName: "components/pricing-cards" */
).then((c) => c.default || c)
...
export const LazyGetStarted = import(
  "../../components/pricing/get-started.vue" /* webpackChunkName: "components/get-started" */
).then((c) => c.default || c)
export const LazyPricingCardsV2 = import(
  "../../components/pricing/pricing-cards-v2.vue" /* webpackChunkName: "components/pricing-cards-v-2" */
).then((c) => c.default || c)
export const LazyPricingDiscount = import(
  "../../components/pricing/pricing-discount.vue" /* webpackChunkName: "components/pricing-discount" */
).then((c) => c.default || c)
export const LazyPricingSupport = import(
  "../../components/pricing/pricing-support.vue" /* webpackChunkName: "components/pricing-support" */
).then((c) => c.default || c)
export const LazyServices = import(
  "../../components/pricing/services.vue" /* webpackChunkName: "components/services" */
).then((c) => c.default || c)
...
export const LazySectionHeader = import(
  "../../components/team/section-header.vue" /* webpackChunkName: "components/section-header" */
).then((c) => c.default || c)
export const LazyTeamList = import(
  "../../components/team/team-list.vue" /* webpackChunkName: "components/team-list" */
).then((c) => c.default || c)
export const LazyTeamMemberCard = import(
  "../../components/team/team-member-card.vue" /* webpackChunkName: "components/team-member-card" */
).then((c) => c.default || c)
export const LazyTeamMember = import(
  "../../components/team/team-member.vue" /* webpackChunkName: "components/team-member" */
).then((c) => c.default || c)
...
export const LazyReviewContent = import(
  "../../components/home/reviews/review-content.vue" /* webpackChunkName: "components/review-content" */
).then((c) => c.default || c)
export const LazyReviews = import(
  "../../components/home/reviews/reviews.vue" /* webpackChunkName: "components/reviews" */
).then((c) => c.default || c)
...
export const LazyToggle = import(
  "../../components/pricing/pre-checkout/toggle.vue" /* webpackChunkName: "components/toggle" */
).then((c) => c.default || c)
